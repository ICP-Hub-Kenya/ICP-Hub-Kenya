      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {startups.map((startup, index) => (
                ...
                <p className="font-thin text-sm mb-12 text-start px-4 sm:px-0">{startup.description}</p>
                ...
                <div className="absolute bottom-0 left-0 right-0 flex justify-center mb-4">
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-6 py-2 bg-white text-gray-900 font-bold border-[1px] border-gray-800 rounded-lg hover:bg-gray-100 transition-colors"
                    >
                     View Project
                    </a>
                </div>
