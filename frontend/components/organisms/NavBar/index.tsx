...
const NavBar = () => {
  ...
  return (
    <nav className={`xl:px-[70px] lg:ml-28 w-[85%] top-5 left-8 z-30 ${isScrolled ? "absolute" : "absolute"}`}>
      <Container>
        <div className="flex items-center justify-between py-4">
          ...
          <div className="hidden lg:flex items-center space-x-4">  {/* Reduced space-x-8 to space-x-4 */}
            ...
            <NavLink href="/our-shop" value="Shop" canActive={true} className="whitespace-nowrap" />
      ...
      {isOpen && (
        <div className="lg:hidden fixed top-8 right-0 w-2/4 bg-white p-4 shadow-lg z-50">
          ...
          <div className="flex flex-col space-y-5">
            ...
            <NavLink href="/our-shop" value="Shop" canActive={true} />
            <NavLink href="https://lu.ma/user/usr-RgJYUVo8GJUSfXd" value="Events" canActive={true} />
            <NavLink href="https://icphub-ke.medium.com/" value="Blog" canActive={true} />
            <NavLink href="/contact" value="Contact" canActive={true} />
            <GradientButton onClick={handleDonateClick}>
